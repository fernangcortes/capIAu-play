...
export function enable() {
    ...
    window.addEventListener('keydown', function (e) {
        ...
        // Skip modified keys (except shift for frame-by-frame: < and > keys)
        ...
        switch (key) {
            ...
            // CapIAu-Streaming: Feature #31 — Frame-by-frame advance
            // . (period) = forward one frame, , (comma) = back one frame
            // Same shortcuts as YouTube and professional NLEs
            case '.':
                inputManager.handleCommand('frameforward');
                break;
            case ',':
                inputManager.handleCommand('frameback');
                break;
